...
if choice.lower() == "left":
    choice = input('You\'ve come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a '
    ...
    if choice.lower() == "wait":
        ...
        if choice.lower() == "red":
            ...
            print("You have found the treasure! Congratulations and enjoy your spoils!")
        elif choice.lower() == "blue":
            print("You enter a room of beasts. Game Over.")
        else:
            print("You have chosen a door that doesn't exist. Game Over.")
    else:
        print("You were attacked by vicious piranhas.  Game Over.")
else:
